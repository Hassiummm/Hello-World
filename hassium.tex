...
\usepackage{textcomp,tocloft,environ,everypage,setspace,geometry,enumerate,enumitem,blindtext,multicol,xcolor,fancyhdr,calligra,graphicx,wrapfig,pgfplots,mdframed,tabularx,lipsum,comment,csquotes}
\usepackage{chemfig}
...
\newcommand{\htoc}{%
    ...
    \vspace{2pt}\phantom{}\hrule\phantom{}
}

% Page number counter renew
\newcounter{custompage}
\setcounter{custompage}{\numexpr\value{page}+1\relax}
\AddEverypageHook{\setcounter{custompage}{\numexpr\value{page}+1\relax}}
...
\newcommand{\bij}{\xrightarrow{\sim}} % right arrow with \sim on it, represents bijection
