...
% Number sign
\newcommand{\ns}{%
  \raisebox{0pt}[0.75ex][0.25ex]{
    \begin{tikzpicture}
      % Vertical lines
      \draw[line cap=round, line width=0.3pt, rotate=-10] (0.05ex, -0.05ex) -- (0.05ex, 1ex);
      \draw[line cap=round, line width=0.3pt, rotate=-10] (0.35ex, 0) -- (0.35ex, 1.05ex);
      % Horizontal lines
      \draw[line cap=round, line width=0.3pt] (0.8ex, 0.65ex) -- (-0.2ex, 0.65ex);
      \draw[line cap=round, line width=0.3pt] (0.8ex, 0.35ex) -- (-0.2ex, 0.35ex);
    \end{tikzpicture}
  }%
}
