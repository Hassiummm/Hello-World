...
% Cayley graph (graphs)
\newcommand{\cnode}[3]{
    \node[circle, fill=black, inner sep=0pt, minimum size=4pt, label=#2:{#3}] (#1) at #1 {\(\bullet\)};
}
\newcommand{\cedge}[2]{
    \draw[thick] (#1) -- (#2);
}
\newcommand{\customedge}[3]{
    \expandafter\newcommand\csname #1\endcsname[2]{\draw[#2, color=#3, thick] (##1) -- (##2);}
}
