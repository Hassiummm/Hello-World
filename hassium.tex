...
\usepackage{imakeidx,textcomp,tocloft,environ,setspace,geometry,enumerate,enumitem,blindtext,multicol,xcolor,fancyhdr,calligra,graphicx,wrapfig,pgfplots,mdframed,tabularx,lipsum,comment,csquotes,verbatim}
...
% Geometry 
\geometry{letterpaper, top=54pt,bottom=46.8pt,marginparsep=5.67pt,marginparwidth=56.69pt,voffset=0pt,hoffset=0pt,left=54pt,right=54pt,headheight=24pt,headsep=10pt}
\setstretch{1.25}
...
% Index page
\makeindex[columns=3,title=Alphabetical Glossary]
...
\newcommand{\hindex}{%
    ...
    \printindex
    \pagestyle{empty}
    \addcontentsline{toc}{section}{\protect\hyperlink{sec-index}{Alphabetical Glossary}}
