...
\usepackage{imakeidx,textcomp,tocloft,environ,setspace,geometry,enumerate,enumitem,blindtext,multicol,xcolor,fancyhdr,calligra,graphicx,etoolbox,wrapfig,pgfplots,mdframed,tabularx,lipsum,comment,csquotes,verbatim,transparent,scalerel,ragged2e,halloweenmath}
...
\geometry{
  ...
  top=0.75in,
  bottom=0.65in,
  marginparsep=0.0785in,
  marginparwidth=0.785in,
  voffset=0in,
  hoffset=0in,
  left=0.75in,
  right=0.75in,
...
\newcommand{\cata}[2]{{\textsf{#1}}^{\textsf{#2}}}
\newcommand{\catb}[2]{{\textsf{#1}}_{\textsf{#2}}}
\newcommand{\catop}[1]{\cata{#1}{op}}
