...
%\def\htitle{Your Title}\def\hauthor{Your Name}\hsetup \htoc \pagestyle{fancy}\fancyhead[L]{\htitle}\fancyhead[R]{\cfc{\hauthor}}\renewcommand{\headrulewidth}{0.5pt}\rule{\linewidth}{0.5pt}
