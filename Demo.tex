...
\begin{verbatim}
    ...
    enumitem,blindtext,multicol,xcolor,fancyhdr,calligra,graphicx,
    wrapfig,pgfplots,mdframed,tabularx,lipsum,comment,csquotes,verbatim}
...
\begin{verbatim}
    ...
    \hindex
\end{verbatim}
The command ``hdef'' mark the word and print it. The command ``hindex'' is a customized index page that print words in three columns. Each page number in the index page contains a hyperlink, you can click it to locate that page.
\section{Darkmode}
