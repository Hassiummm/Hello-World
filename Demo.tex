...
\section{Darkmode}
Darkmode command changes the background color to black and the text to white. If you are using the ``htoc'' command with the darkmode, please use ``darkhtoc''. I will combine the functions later after the exam. Use the commands by:
\begin{verbatim}
    \begin{document}
        \darkmode 
        \darkhtoc
