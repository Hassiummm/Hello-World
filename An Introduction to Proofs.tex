...
\end{example}
\begin{problem}
    Write out the set of all positive integers, the set of all prime numbers, and the set of all points on a circle with center $(0,0)$ and radius 1 in 3-dimensional Euclidean space.
\end{problem}
\begin{definition}
